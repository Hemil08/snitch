            ...
            >
                ...
                <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden" style={{ backgroundColor: '#f5f3f0' }}>
                    ...
                    <div className="absolute inset-0 p-14 flex flex-col justify-between z-10">
                        <span
                            className="text-lm font-medium tracking-[0.34em] uppercase"
                            style={{ fontFamily: "'Cormorant Garamond', serif", color: '#f0c067' }}
                        >
                            Snitch.
                        </span>
                        <div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <input
                                        ...
                                        placeholder="+49"
                                        maxLength="4"
                                        className="w-20 bg-transparent outline-none py-3 text-sm transition-colors duration-300"
                                        style={inputStyle}
                                        onFocus={handleFocus}
                                        onBlur={handleBlur}
                                    />
